...
| A validated appearance interpretation of skin-to-hair contrast | No re-sourcing occurred, and the page is unchanged. Its result copy still attributes the contrast mismatch to geometry alone; the correction lives here rather than on the page. |
