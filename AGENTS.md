...
- This is the captain's personal project on his personal GitHub account `dbeihl`. The validation pipeline authenticates through Git credential helpers wired into this project clone and its gate repository, per clone. Nothing crosses between this repository and any work repository in either direction.
